...
<header
  class="relative overflow-hidden flex justify-center items-center h-screen text-center mb-8 lg:mb-20"
>
  <svg
    class="background"
    id="masks"
  ...
  <div class="flex flex-col items-center w-80">
    ...
    />
    <h1>Allmaps</h1>
    <h2>Curating, georeferencing and exploring for IIIF maps</h2>
    <p>
      ...
      explore, georeference and work with collections of digitized maps.
    </p>
  </div>
</header>
